...
public class ObjectEventIntro : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // initial idle state
        TimeAction initialTA = new TimeAction("init", "Init");

        ActionCondition[] introConds = { acm.Intro };
        TimeAction intro = new TimeAction("intro", "Intro", introConds);
        allActions.Add(intro);

        ActionCondition[] goodEndingConds = { acm.GoodEnding };
        TimeAction goodEnding = new TimeAction("goodEnding", "GoodEnding", goodEndingConds);
        allActions.Add(goodEnding);

        ActionCondition[] badEndingConds = { acm.BadEnding };
        TimeAction badEnding = new TimeAction("badEnding", "BadEnding", badEndingConds);
        allActions.Add(badEnding);
    ...
    public void showIntro()
    {
        ...
        string txt = "You are Franklin Clockenspiel, the former proprietor of The Second Hand: an antique clock shop.\n\nFor generations " +
    ...
    public void showGoodEnding()
    {
        ...
        string txt = "You managed to halt the sale of the store, much to the dismay of Beauregard. What you hoped would put things back to normal, had the opposite effect. " +
            "Your niece owned the shop for several more years but the entire time she seemed to be on autopilot.\n\nThe excitement of opening a new shop to her vision and the" +
            " falling out of that vision left her drained. She felt she was only doing this for you.\n\nBut at least The Second Hand still stands.";
    ...
    public void showBadEnding()
    {
        ...
        string txt = "With the offers made by Beauregard and his buyers, your niece sold the shop. With it she went on to open a new shop elsewhere. \n\nYou on the other hand, " +
            "with The Second Hand no longer standing, had to let your spirit pass on. The saving grace in your passing was seeing your Niece follow her dreams. ";
